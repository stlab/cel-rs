...
dependency. Declaration order is not just documentation style here; it is meaningful both for
name resolution and, as [Chapter 4](relationships.md) covers, for the solver's initial notion
of which cells are "fresher" than others.
